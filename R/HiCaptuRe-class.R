...
setMethod("getParameters", c(x = "HiCaptuRe"),function(x){return(x@parameters)})

setGeneric("setParameters", function(x,y){standardGeneric("setParameters")})
...
setGeneric("getByBaits", function(x){standardGeneric("getByBaits")})

setMethod("getByBaits", c(x = "HiCaptuRe"),function(x){return(x@ByBaits)})

setGeneric("setByBaits", function(x,y){standardGeneric("setByBaits")})
...
setGeneric("getByRegions", function(x){standardGeneric("getByRegions")})

setMethod("getByRegions", c(x = "HiCaptuRe"),function(x){return(x@ByRegions)})


setGeneric("setByRegions", function(x,y){standardGeneric("setByRegions")})
